...
$query2 = "select * from personalaps.tbl_distribucion_frecuencias_lugar_nacimiento_trabajo_bienestar;";

// Ejecutar la consulta y obtener los datos
$stmt = $conexion->query($query2);
$resultados2 = $stmt->fetchAll();

$query3 = "select * from personalaps.tbl_relacion_origen_trabajo_frecuencia_porcentaje_bienestar;";
